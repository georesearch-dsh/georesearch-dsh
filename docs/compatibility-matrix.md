...
| --- | --- | --- |
| DeepSeek Harness | `0.1.0-rc.5` plus `structured-output-bounded-recovery-and-array-limits-v1` | Official source archive commit `47f943859bef60e4160492346772ded9b24f765a`; archive and source-tree digests are recorded in `phase0-baseline.json`, and every permitted local difference is fixed by `harness-local-patch.json`. |
